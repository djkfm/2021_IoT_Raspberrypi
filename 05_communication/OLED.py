...
font2 = ImageFont.truetype("/usr/share/fonts/truetype/dejavu/DejaVuSerif-Bold.ttf", 14)


# Draw the text
draw.text((0, 0), "1319", font=font, fill=255)
draw.text((0, 30), "Yaung Seung Cheol", font=font2, fill=255)
draw.text((34, 46), "IOT GGuljam", font=font2, fill=255)
